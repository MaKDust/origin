...
@if ((Auth::user() != null) && (Auth::user()->role == "1"))
            <div class="adminButtons ">
                <button class="btn btn-outline-primary btn-xs" data-toggle="tooltip" data-placement="down" title="Metricas"><a class="nav-link" href="{{url('/metrics')}}"><i class="fas fa-chart-bar"></i></a></button>
