                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-group">
                                                <label for="validationTooltipCardNumber"><strong>NOMBRE TITULAR</strong>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="validationTooltipCardNumber"><strong>NUMBERO DE TARJETA</strong>
                                                </label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control border-right-0" id="validationTooltipCardNumber" placeholder="XXXX - XXXX - XXXX - XXXX">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text rounded-right" id="validationTooltipCardNumber"><i class="fa fa-credit-card"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-8 col-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputExpirationDate"><strong>EXPIRATION DATE</strong>
                                                        </label>
